...
class PdfReportGenerator:
    ...
    def create_and_save_report(self, img, data, filepath, pagesize=A4):
        pdf_template = self.__create_pdf_template(filepath, img, data, pagesize)
        pdf_template.setTitle(self.__title)
        pdf_template.save()

    def __create_pdf_template(self, filepath, img, data, pagesize):
